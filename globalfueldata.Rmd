...
legend <- get_legend(power_plot13 + theme(legend.position = "bottom"))


grid.arrange(arrangeGrob(power_plot13 + theme(legend.position = "none"), 
             power_plot17+ theme(legend.position = "none"), 
             nrow = 1), legend, nrow = 2, heights = c(10,1))
```